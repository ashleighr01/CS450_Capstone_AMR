...
<html>
    ...
    <body id="Contents">
        ...
        <div id="exerciseSelection">
            <h1><strong>It's an Upper Body Day!</strong></h1><br>
        ...
        Once selected, each exercise, repetitions, sets, and any cardio or core supplements will be displayed.</p>
            <select name="exercises1" onchange="showWorkout(this.value)">
                <option value=""> Select your first exercise:</option>
                <option value="Dips"> Dips</option>
                <option value="HammerCurls"> Hammer Curls</option>
                <option value="Pushups"> Pushups</option>
                <option value="TricepExtend"> Tricep Extensions</option>
                <option value="BentRows"> Bent-Over Rows</option>
                <option value="Arnolds"> Arnold Press</option>
            </select> <br>
            <select name="exercises2" onchange="showWorkout(this.value)">
            ...
            <select name="exercises3" onchange="showWorkout(this.value)">
            ...
            <select name="exercises4" onchange="showWorkout(this.value)">
